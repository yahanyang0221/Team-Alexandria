...
hd_graduation_columns = ["OPEID", "YEAR"]
...
hd_faculty_columns = ["OPEID"]

score_faculty_columns = ["OPEID", "AVGFACSAL"]
...
hd_admission_columns = ["OPEID", "YEAR"]
